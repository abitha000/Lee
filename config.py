...
# REQUIRED CONFIG
BOT_TOKEN = "7863687390:AAH-kILW_dUilGVKYjttT4NUp7lWtcVYJkE"                              # Require restart after changing it while bot running
OWNER_ID = "7255612720"                               # Require restart after changing it while bot running
TELEGRAM_API = "24401235"                           # Require restart after changing it while bot running
TELEGRAM_HASH = "149f7e13d7d861b27cffc3ab1fd52b22"                          # Require restart after changing it while bot running

# OPTIONAL CONFIG
USER_SESSION_STRING = ""                    # Require restart after changing it while bot running
DATABASE_URL = "mongodb+srv://avineyjr004:KaiNey009@cluster0.wla20hl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"                           # Require restart after changing it while bot running
...
AUTHORIZED_CHATS = "-1002747283382"                       # Require restart after changing it while bot running
SUDO_USERS = "7255612720"                             # Require restart after changing it while bot running
...
LEECH_LOG_ID = "-1002747283382"
MIRROR_LOG_ID = "-1002747283382"
LINKS_LOG_ID = "-1002747283382"
